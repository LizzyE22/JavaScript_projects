var obj = { "Producer":"Hundred Suns Wines", "vintage":"2019",
"variety":"Pinot Noir"};
var myJSON = JSON.stringify(obj);
document.getElementById("demo").innerHTML = myJSON;

var obj = JSON.parse('{"year":"2019", "grape":"Pinot Noir"}');

document.getElementById("demo2").innerHTML = obj.grape;

// Set item
localStorage.setItem("lastname", "Brown");
// Retrieve
